...
def transformData(data):
    ...
    for feature in CATEGORICAL_FEATURES:
        ...
        dummies = pd.get_dummies(
            categorical, prefix=feature, columns=categorical.unique())
...
def getPrediction():
    ...
    middleNameCount = request.args.get('middleNameCount')
    draftNumber = request.args.get('draftNumber')
    asDataFrame = pd.DataFrame({
        'college_' + college: [1],
        'rings': [rings],
        'siblings': [siblings],
